...
class _SavedPostScreenState extends State<SavedPostScreen> {
  ...
  final List<String> imageUrls = [
    ...
    'https://images.unsplash.com/photo-1561948955-570b270e7c36?q=80&w=400', // Cat
  ];
      ...
      body: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                _buildTabButton('Post', selectedTab == 'Post'),
                const SizedBox(width: 10),
                _buildTabButton('Videos', selectedTab == 'Videos'),
              ],
            ),
          ),
